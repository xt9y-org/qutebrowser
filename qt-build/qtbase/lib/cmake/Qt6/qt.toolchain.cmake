...
set(__qt_toolchain_use_vcpkg FALSE)
if(QT_USE_VCPKG OR (NOT DEFINED QT_USE_VCPKG AND __qt_initially_configured_use_vcpkg)
    AND DEFINED ENV{VCPKG_ROOT})
    set(__qt_toolchain_use_vcpkg TRUE)
endif()

if(__qt_toolchain_use_vcpkg)
    set(__qt_toolchain_vcpkg_root "$ENV{VCPKG_ROOT}")
    if(NOT __qt_toolchain_vcpkg_root OR NOT EXISTS "${__qt_toolchain_vcpkg_root}")
        set(__qt_toolchain_use_vcpkg FALSE)
        message(FATAL_ERROR "The VCPKG_ROOT environment variable is set to "
            "'${__qt_toolchain_vcpkg_root}', but this path doesn't exist. "
            "Vcpkg support will be disabled.")
    endif()
    unset(__qt_toolchain_vcpkg_root)
endif()
...
unset(__qt_toolchain_use_vcpkg)
