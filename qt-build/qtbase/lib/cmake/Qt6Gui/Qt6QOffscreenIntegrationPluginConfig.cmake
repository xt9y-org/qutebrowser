...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QOffscreenIntegrationPluginTargetsPrecheck.cmake")

if(NOT __qt_QOffscreenIntegrationPlugin_skip_include_targets_file)
    ...
    if(QOffscreenIntegrationPlugin_FOUND)
        ...
        set(__qt_QOffscreenIntegrationPlugin_targets_file_included ON)
    endif()
endif()
