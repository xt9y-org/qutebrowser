...
#include "../../../../../../qt6/qtbase/src/network/kernel/qdnslookup_p.h"
...
template <> constexpr inline auto QDnsLookupRunnable::qt_create_metaobjectdata<qt_meta_tag_ZN18QDnsLookupRunnableE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'finished'
        QtMocHelpers::SignalData<void(const QDnsLookupReply &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<QDnsLookupRunnable, qt_meta_tag_ZN18QDnsLookupRunnableE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QDnsLookupRunnable::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18QDnsLookupRunnableE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18QDnsLookupRunnableE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18QDnsLookupRunnableE_t>.metaTypes,
    nullptr
} };
