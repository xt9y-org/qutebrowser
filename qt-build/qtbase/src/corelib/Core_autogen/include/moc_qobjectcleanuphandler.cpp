...
#include "../../../../../../qt6/qtbase/src/corelib/kernel/qobjectcleanuphandler.h"
...
template <> constexpr inline auto QObjectCleanupHandler::qt_create_metaobjectdata<qt_meta_tag_ZN21QObjectCleanupHandlerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QObjectCleanupHandler, qt_meta_tag_ZN21QObjectCleanupHandlerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QObjectCleanupHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QObjectCleanupHandlerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QObjectCleanupHandlerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21QObjectCleanupHandlerE_t>.metaTypes,
    nullptr
} };
...
void *QObjectCleanupHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QObjectCleanupHandlerE_t>.strings))
